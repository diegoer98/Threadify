...
<section id="portfolio" class="section">
  <div class="wrap">
    ...
    <!-- ── Slideshow: 6 photos, all 1080x1080, displayed at natural size ── -->
    <div class="portfolio-slideshow">

      <div class="ps-slide ps-active">
        <img src="<?php echo get_template_directory_uri(); ?>/images/slide-corporate.jpg"
             alt="Salesforce embroidered hoodies – corporate bulk order" width="1080" height="1080">
        <div class="ps-caption">Corporate Branding</div>
      </div>

      <div class="ps-slide">
        <img src="<?php echo get_template_directory_uri(); ?>/images/slide-horse.jpg"
             alt="Year of the Horse EQC – custom digitized embroidery" width="1080" height="1080">
        <div class="ps-caption">Design &amp; Digitizing</div>
      </div>

      <div class="ps-slide">
        <img src="<?php echo get_template_directory_uri(); ?>/images/slide-hats.png"
             alt="Hat embroidery in progress on commercial machine" width="1080" height="1080">
        <div class="ps-caption">Hats &amp; Headwear</div>
      </div>

      <div class="ps-slide">
        <img src="<?php echo get_template_directory_uri(); ?>/images/slide-shenron.jpg"
             alt="Custom dragon embroidery – detailed stitch work" width="1080" height="1080">
        <div class="ps-caption">Custom Embroidery</div>
      </div>

      <div class="ps-slide">
        <img src="<?php echo get_template_directory_uri(); ?>/images/slide-ky.jpg"
             alt="Kappa Psi Beta Omicron personalized embroidery" width="1080" height="1080">
        <div class="ps-caption">Personalized &amp; Club Apparel</div>
      </div>

      <div class="ps-slide">
        <img src="<?php echo get_template_directory_uri(); ?>/images/slide-machine.png"
             alt="Commercial embroidery machine in action" width="1080" height="1080">
        <div class="ps-caption">Our Equipment</div>
      </div>

      <!-- Arrows (positioned over the image) -->
      <button class="ps-arrow ps-prev" aria-label="Previous photo">&#8249;</button>
      <button class="ps-arrow ps-next" aria-label="Next photo">&#8250;</button>

      <!-- Caption is inside each slide above, arrows above, dots below -->
      <div class="ps-dots-bar">
        <button class="ps-dot ps-dot-active" data-index="0" aria-label="Photo 1"></button>
        <button class="ps-dot" data-index="1" aria-label="Photo 2"></button>
        <button class="ps-dot" data-index="2" aria-label="Photo 3"></button>
        <button class="ps-dot" data-index="3" aria-label="Photo 4"></button>
        <button class="ps-dot" data-index="4" aria-label="Photo 5"></button>
        <button class="ps-dot" data-index="5" aria-label="Photo 6"></button>
      </div>
...
(function () {
  ...
  function next_slide() { show(current + 1); }
  function prev_slide() { show(current - 1); }
  ...
  /* Arrow clicks */
  if (prev) prev.addEventListener('click', function () { prev_slide(); start(); });
  if (next) next.addEventListener('click', function () { next_slide(); start(); });

  /* Pause on hover */
  var box = document.querySelector('.portfolio-slideshow');
  if (box) {
  ...
  if (box) {
    ...
    box.addEventListener('touchend', function (e) {
      ...
      if (Math.abs(dx) > 40) { dx < 0 ? next_slide() : prev_slide(); start(); }
    }, { passive: true });
  }
